...
val_pred = best_lasso.predict(X_val)
...
predictions_df.to_csv('output/lasso_predictions.csv', index=False)
print("Predictions saved to output/lasso_predictions.csv")
