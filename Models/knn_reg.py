...
grid_search = GridSearchCV(knn_model, param_grid, cv=3, scoring='neg_root_mean_squared_error', n_jobs=-1)
...
predictions_df.to_csv('output/knn_predictions.csv', index=False)
print("Predictions saved to output/knn_predictions.csv")
