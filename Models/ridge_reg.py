...
# Scale features to handle multicollinearity
...
val_pred = best_ridge.predict(X_val_scaled)
...
predictions_df.to_csv('output/ridge_predictions.csv', index=False)
print("Predictions saved to output/ridge_predictions.csv")
