...
grid_search = GridSearchCV(xgb_model, param_grid, cv=3, scoring='neg_root_mean_squared_error', n_jobs=-1)
...
predictions_df.to_csv('output/xgboost_predictions.csv', index=False)
print("Predictions saved to output/xgboost_predictions.csv")
